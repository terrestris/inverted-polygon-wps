...
public abstract class InvertedPolygonBase {

  private static final Logger LOGGER = Logging.getLogger(InvertedPolygonBase.class);

  protected String computeInvertedPolygon(FeatureCollection<?, ?> inputFeatures) {
